       ...
       // store backUp file into temp folder
        switch (fileNum) {
            case 0:
                ...
                Files.copy(Paths.get("webapps/BadAPPles/backUp-0/" + backUpFile), Paths.get("webapps/BadAPPles/temp/" + file));
                break;
            case 1:
                file = fileNames[fileNum] + ".csv";
                clean.removeFile(new File("webapps/BadAPPles/temp/" + file));
                Files.copy(Paths.get("webapps/BadAPPles/backUp-1/" + backUpFile), Paths.get("webapps/BadAPPles/temp/" + file));
                break;
            case 2:
                file = fileNames[fileNum] + ".csv";
                clean.removeFile(new File("webapps/BadAPPles/temp/" + file));
                Files.copy(Paths.get("webapps/BadAPPles/backUp-2/" + backUpFile), Paths.get("webapps/BadAPPles/temp/" + file));
                break;
            case 3:
                file = fileNames[fileNum] + ".csv";
                clean.removeFile(new File("webapps/BadAPPles/temp/" + file));
                Files.copy(Paths.get("webapps/BadAPPles/backUp-3/" + backUpFile), Paths.get("webapps/BadAPPles/temp/" + file));
                break;
            case 4:
                file = fileNames[fileNum] + ".csv";
                clean.removeFile(new File("webapps/BadAPPles/temp/" + file));
                Files.copy(Paths.get("webapps/BadAPPles/backUp-4/" + backUpFile), Paths.get("webapps/BadAPPles/temp/" + file));
                break;
            case 5:
                file = fileNames[fileNum] + ".csv";
                clean.removeFile(new File("webapps/BadAPPles/temp/" + file));
            ...
            case 100:
               ...
               // move all original files into temp folder
                ...
                Files.copy(Paths.get("webapps/BadAPPles/backUp-1/" + file), Paths.get("webapps/BadAPPles/temp/" + file));

                file = fileNames[2] + ".csv";
                Files.copy(Paths.get("webapps/BadAPPles/backUp-2/" + file), Paths.get("webapps/BadAPPles/temp/" + file));

                file = fileNames[3] + ".csv";
                Files.copy(Paths.get("webapps/BadAPPles/backUp-3/" + file), Paths.get("webapps/BadAPPles/temp/" + file));

                file = fileNames[4] + ".csv";
                Files.copy(Paths.get("webapps/BadAPPles/backUp-4/" + file), Paths.get("webapps/BadAPPles/temp/" + file));

                file = fileNames[5] + ".csv";
                Files.copy(Paths.get("webapps/BadAPPles/backUp-5/" + file), Paths.get("webapps/BadAPPles/temp/" + file));
